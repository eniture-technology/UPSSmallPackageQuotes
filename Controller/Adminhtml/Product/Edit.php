...
namespace Eniture\UPSSmallPackageQuotes\Controller\Adminhtml\Product;
...
/**
 * Class Edit deals with available DS source by active En Carrier App
 */
class Edit extends ParentEdit
{
    ...
    public function execute()
    {
        ...
        $collection = $this->enModuleFactoryCreate->getCollection()
            ->addFilter('module_name', ['eq' => 'ENUPSSmpkg']);
    ...
    public function varifyModuleEntry($haveEntry)
    {
        if (empty($haveEntry)) {
            $data = [
                'module_name'           => 'ENUPSSmpkg',
                'module_script'         => 'Eniture_UPSSmallPackageQuotes',
